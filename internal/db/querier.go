...
type Querier interface {
	CreateCriticReview(ctx context.Context, arg CreateCriticReviewParams) (CriticReview, error)
	CreateFile(ctx context.Context, arg CreateFileParams) (File, error)
	CreateMessage(ctx context.Context, arg CreateMessageParams) (Message, error)
	CreateSession(ctx context.Context, arg CreateSessionParams) (Session, error)
	CreateToolcoachEffectiveness(ctx context.Context, arg CreateToolcoachEffectivenessParams) (ToolcoachEffectiveness, error)
	...
	GetCriticReviewByMessageID(ctx context.Context, messageID string) (CriticReview, error)
	...
	GetToolcoachEffectivenessByPattern(ctx context.Context, arg GetToolcoachEffectivenessByPatternParams) ([]GetToolcoachEffectivenessByPatternRow, error)
	...
	ListCriticReviewsBySession(ctx context.Context, sessionID string) ([]CriticReview, error)
	...
	PruneCriticReviews(ctx context.Context, createdAt int64) (int64, error)
	PruneToolcoachEffectiveness(ctx context.Context, createdAt int64) (int64, error)
