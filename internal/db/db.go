...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.createToolcoachEffectivenessStmt, err = db.PrepareContext(ctx, createToolcoachEffectiveness); err != nil {
		return nil, fmt.Errorf("error preparing query CreateToolcoachEffectiveness: %w", err)
	}
	...
	if q.getToolcoachEffectivenessByPatternStmt, err = db.PrepareContext(ctx, getToolcoachEffectivenessByPattern); err != nil {
		return nil, fmt.Errorf("error preparing query GetToolcoachEffectivenessByPattern: %w", err)
	}
	...
	if q.pruneCriticReviewsStmt, err = db.PrepareContext(ctx, pruneCriticReviews); err != nil {
		return nil, fmt.Errorf("error preparing query PruneCriticReviews: %w", err)
	}
	if q.pruneToolcoachEffectivenessStmt, err = db.PrepareContext(ctx, pruneToolcoachEffectiveness); err != nil {
		return nil, fmt.Errorf("error preparing query PruneToolcoachEffectiveness: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.createToolcoachEffectivenessStmt != nil {
		if cerr := q.createToolcoachEffectivenessStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing createToolcoachEffectivenessStmt: %w", cerr)
		}
	}
	...
	if q.getToolcoachEffectivenessByPatternStmt != nil {
		if cerr := q.getToolcoachEffectivenessByPatternStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getToolcoachEffectivenessByPatternStmt: %w", cerr)
		}
	}
	...
	if q.pruneCriticReviewsStmt != nil {
		if cerr := q.pruneCriticReviewsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing pruneCriticReviewsStmt: %w", cerr)
		}
	}
	if q.pruneToolcoachEffectivenessStmt != nil {
		if cerr := q.pruneToolcoachEffectivenessStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing pruneToolcoachEffectivenessStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	createToolcoachEffectivenessStmt       *sql.Stmt
	...
	getToolcoachEffectivenessByPatternStmt *sql.Stmt
	...
	pruneCriticReviewsStmt                 *sql.Stmt
	pruneToolcoachEffectivenessStmt        *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		createToolcoachEffectivenessStmt:       q.createToolcoachEffectivenessStmt,
		...
		getToolcoachEffectivenessByPatternStmt: q.getToolcoachEffectivenessByPatternStmt,
		...
		pruneCriticReviewsStmt:                 q.pruneCriticReviewsStmt,
		pruneToolcoachEffectivenessStmt:        q.pruneToolcoachEffectivenessStmt,
